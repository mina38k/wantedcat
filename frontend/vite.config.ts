...
export default defineConfig({
  ...
  server: {
    ...
    allowedHosts: ['5174-mina38k-wantedcat-gdovbp9op7h.ws-us121.gitpod.io'],
    proxy: {
            '/api': { target: 'https://8080-mina38k-wantedcat-gdovbp9op7h.ws-us121.gitpod.io', changeOrigin: true }
      ,
      '/hls': {
